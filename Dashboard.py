...
# First part of the app: the form style:
...
with st.form("transaction_form"):
    ...
    if invoice_status == "Approved":
        # Invoice Details
        payment_request_num1 = st.text_input("Payment Request Invoice Number")
        payment_request_num2 = st.text_input("Payment Request Invoice Number")
        payment_request_num3 = st.text_input("Payment Request Invoice Number")
        payment_request_num4 = st.text_input("Payment Request Invoice Number")
        payment_request_num5 = st.text_input("Payment Request Invoice Number")
        ...
        payment_date1 = st.text_input("Payment Date (YYYYMMDD)")
        payment_date2 = st.text_input("Payment Date (YYYYMMDD)")
        payment_date3 = st.text_input("Payment Date (YYYYMMDD)")
        payment_date4 = st.text_input("Payment Date (YYYYMMDD)")
        payment_date5 = st.text_input("Payment Date (YYYYMMDD)")
